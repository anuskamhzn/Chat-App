...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left Image Section */}
      <div className="hidden lg:flex w-1/2 bg-cover bg-center relative" style={{ backgroundImage: `url(${require('../../img/login.jpg')})` }}>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full h-full text-white text-center px-6">
          <h1 className="text-5xl font-bold mb-4">Chatly</h1>
          <p className="text-lg">Connect seamlessly and enhance your conversations with ease.</p>
        </div>
      </div>
